...
public class RevisarEscenaTest
{
    ...
    [Test]
    public void RevisarEscenaFacilOnlin()
    {

        var engine = new RevisarEscena();

        int _FocosParaNivel = 4;
        int _EscenaActual = 17;
    ...
    [Test]
    public void RevisarEscenaNormalOnlin()
    {

        var engine = new RevisarEscena();

        int _FocosParaNivel = 6;
        int _EscenaActual = 18;
    ...
    [Test]
    public void RevisarEscenaDificilOnlin()
    {

        var engine = new RevisarEscena();

        int _FocosParaNivel = 8;
        int _EscenaActual = 19;
    ...
    [Test]
    public void RevisarEscenaExtremoOnlin()
    {

        var engine = new RevisarEscena();

        int _FocosParaNivel = 10;
        int _EscenaActual = 20;
